...
/**
 * unknown error에서 안전하게 error message를 얻는 utility function
 */
...
/**
 * unknown error에서 안전하게 error stack을 얻는 utility function
 */
...
/**
 * progress tracking과 error handling을 통해 upload 시도를 처리
 */
...
/**
 * 완전한 upload workflow - URL 검색, upload 시도, error 상태를 처리
 */
