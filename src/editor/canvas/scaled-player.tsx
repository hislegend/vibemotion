...
// import {CropOverlayWrapper} from '../crop/CropOverlay';
// === END CROP FEATURE ===
...
import {TemplateCanvasOverlay} from '../template/template-canvas-overlay';
...
export const ScaledPlayer = ({
	...
	const outer: React.CSSProperties = useMemo(() => {
		return {
			...
			overflow: 'visible', // CropOverlay 등 오버레이 요소가 영역 바깥에도 표시될 수 있도록
		};
	}, [
				...
				<CanvasTransformationContext.Provider value={canvasTransformation}>
					<div style={outer}>
						<div style={style}>
							...
							/>
							{/* === CROP FEATURE DISABLED - TODO: Re-enable later === */}
							{/* {editMode === 'crop' && <CropOverlayWrapper />} */}
							{/* === END CROP FEATURE === */}
							{/* 템플릿 편집 모드 오버레이 - style div 안에서 transform 상속 */}
