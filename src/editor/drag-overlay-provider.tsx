...
export const DragOverlayProvider: React.FC<DragOverlayProviderProps> = ({
	...
	const startDrag = useCallback(
		(params: StartDragParams) => {
			...
			// 기존 ref를 사용하여 timeline container 가져오기
			const containerRect =
