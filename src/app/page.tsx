...
const PRESET_PROMPTS: PresetPrompt[] = [
  ...
  },
  {
    ...
    label: "카드뉴스: 디자인 특허",
    prompt:
      '카드뉴스를 Remotion React 코드로 바로 생성해줘. 1080x1350 (4:5). 6장 슬라이드를 <Sequence>로 연결. 슬라이드당 90프레임(3초), 총 540프레임. 표지: 다크 그라데이션 배경 + "경쟁사가 베끼는 건 기술이 아닙니다" 헤드라인. 본문1(목록형): 디자인 특허 핵심 요소 4가지, 번호 뱃지 + 순차 spring 등장. 본문2(비교형): 보호 전 vs 후 2열 비교. 본문3(단계형): 출원 3단계 프로세스. 본문4(강조형): "외관이 곧 경쟁력" 큰 인용. 마무리: 로고 + CTA. Pretendard 폰트, 블루(#3b82f6) 악센트, safe zone 상하좌우 여백. 코드만 출력해.',
    aspectRatio: "4:5",
  },
];
